<template>
  <el-container class="blacklist con">
    <el-header>
      <!--面包屑-->
...
<script>
  ...
  const tableOperationData = {
    ...
    buttonList: [
      ...
      {type: 'button', operating: 'addAccount', buttonName: '添加黑名单'}
    ]
  };
  // 表格假数据
  ...
  export default {
    ...
    created() {
      let vue = this
      vue.tableData = Data.data.blacklist;
    },
    mounted() {
    },
    methods: {
        ...
        let formObj = {
          ...
          formData: {
            ...
            formList: [
              ...
              {type: 'input', inputType: 'text', disabled: false, inputLabel: '号码/账号', modelName: 'userAccount', placeholder: '请输入号码/账号', required: true, defaultValue: null},
            ]
          }
        };
        ...
        let formObj = {
          ...
          formData: {
            ...
            formList: [
              ...
              {type: 'input', inputType: 'text', disabled: false, inputLabel: '号码/账号', modelName: 'userAccount', placeholder: '请输入号码/账号', required: true, defaultValue: item.userAccount},
            ]
          }
        };
        item.dialog = true;
